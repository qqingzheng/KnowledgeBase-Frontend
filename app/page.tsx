    ...
    <div className="items-center justify-center bg-white flex w-screen h-screen">
      <div className="flex flex-row ring-1 ring-slate-200 shadow-xl rounded-xl w-[60%] h-[70%] overflow-hidden">
        <div className="flex flex-col items-center w-full md:w-1/2 h-full">
          ...
          <form className="flex flex-col items-center gap-y-4 mt-12 mx-16">
            <input className="w-full h-8 px-5 py-2 w-11/12 ring-1 ring-slate-200 rounded-full" placeholder="用户名"></input>
            <input className="w-full h-8 px-5 py-2 w-11/12 ring-1 ring-slate-200 rounded-full" placeholder="密码"></input>
